...
export default class ProjectExperience extends React.Component {
  ...
  constructor(props) {
    ...
    this.projects = [
      ...
      new Project('5', 'Celcom M2M Platform 구축','CODEbean', '2014.03', '2014.07', ['Java', 'Spring', 'Oracle'], 'Web Admin 개발'),
      ...
      new Project('16', 'SKT UAPS C API & Daemon 추가 연동 개발','WideTNS', '2010.01', '2010.04', ['C', 'C++', 'Socket'], '프로세스 버그 수정 및 추가 기능 개발'),
